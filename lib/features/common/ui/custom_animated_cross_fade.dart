...
///. Signature for the [CustomAnimatedCrossFade.layoutBuilder] callback.
///
...
/// ```
/// {@end-tool}
typedef CustomAnimatedCrossFadeBuilder = Widget Function(
...
/// [CustomAnimatedCrossFade] is rebuilt with a different value for the
...
/// [CustomAnimatedCrossFade] widget cross-fades between the two forms of the logo
/// over three seconds.
///
/// ```dart
...
///  * [AnimatedSize], the lower-level widget which [CustomAnimatedCrossFade] uses to
...
class CustomAnimatedCrossFade extends StatefulWidget {
  ...
  ///
  /// By default, this uses [CustomAnimatedCrossFade.defaultLayoutBuilder], which uses
  ...
  /// constraints. This works well when the [CustomAnimatedCrossFade] is in a position
  ...
  /// [CustomAnimatedCrossFade] is being forced to a particular size, then it can
  /// result in the widgets jumping about when the cross-fade state is changed.
  final CustomAnimatedCrossFadeBuilder layoutBuilder;
  ...
  /// The default layout algorithm used by [CustomAnimatedCrossFade].
  ///
  ...
  /// [CustomAnimatedCrossFadeBuilder].
